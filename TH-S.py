...
Sigma = CoefficientFunction((sigma[0],sigma[1],sigma[1],sigma[2]),dims=(2,2))
Tau = CoefficientFunction((tau[0],tau[1],tau[1],tau[2]),dims=(2,2))
gfuDu = 0.5*(grad(gfu.components[0])+grad(gfu.components[0]).trans)
gfuSigma = CoefficientFunction((gfu.components[2][0],gfu.components[2][1],gfu.components[2][1],gfu.components[2][2]),
                               dims=(2,2))
